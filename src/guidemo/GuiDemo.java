...
public class GuiDemo extends JFrame {
	...
	private CreateAboutMenu createAboutMenu;
	...
	public GuiDemo() {
		...
		super("Mahmoud Alsalmo"); // Specifies the string for the title bar of the window.
		...
		drawPanel.getTextItem()
				.setText("If a potato can\n" + "become vodka,\n" + "you can\n" + "becoma a,\n" + "WEB DEVELOPER.");
		drawPanel.getTextItem().setFontSize(42);
		drawPanel.getTextItem().setColor(Color.RED);
		drawPanel.getTextItem().setBold(true);
		drawPanel.getTextItem().setJustify(TextItem.CENTER);
		drawPanel.setBackgroundImage(Util.getImageResource("resources/images/potato.jpg"));
		...
		createAboutMenu = new CreateAboutMenu(drawPanel);
	...
	private class ChooseBackgroundAction extends AbstractAction {
		...
		ChooseBackgroundAction(String text) {
			...
			if (text.equals("Color...")) {
				...
				putValue(Action.SMALL_ICON, Util.iconFromResource("resources/action_icons/tools.png"));
			} else {
